...
function getVersionList (cb) {
  ...
  https.get('https://elementrem.github.io/solc-bin/bin/list.json', function (response) {
...
function downloadBinary (version) {
  ...
  https.get('https://elementrem.github.io/solc-bin/bin/' + version, function (response) {
    if (response.statusCode !== 200) {
      console.log('Error downloading file: ' + response.statusCode);
      process.exit(1);
    }
